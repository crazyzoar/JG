...
namespace JG_Prospect.BLL
{
    public class InstallUserBLL
    {
        ...
        public DataSet GetSalesUsersStaticticsAndData(string strSearchTerm, string strStatus, Int32 intDesignationId, Int32 intSourceId, DateTime? fromdate, DateTime? todate, string AddedByDesignation, int intPageIndex, int intPageSize, string strSortExpression)
        {
            return InstallUserDAL.Instance.GetSalesUsersStaticticsAndData(strSearchTerm, strStatus, intDesignationId, intSourceId, fromdate, todate, AddedByDesignation, intPageIndex, intPageSize, strSortExpression);
        }
        ...
        public DataSet CheckRejectionReason(string Reason)
        {
            return InstallUserDAL.Instance.CheckDuplicateRejectionReason(Reason);
        }
        public DataSet GetRejectionReason()
        {
            return InstallUserDAL.Instance.GetRejectionReason();
        }
        public DataSet AddRejectionReason(string Reason)
        {
            return InstallUserDAL.Instance.AddRejectionReason(Reason);
        }
        public void DeleteRejectionReason(string Reason)
        {
            InstallUserDAL.Instance.DeleteRejectionReason(Reason);
        }
        #endregion Code Added by Sonali Agarwal on 21Apr,2017
