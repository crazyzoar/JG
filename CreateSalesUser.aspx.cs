...
namespace JG_Prospect.Sr_App
{
    public partial class CreateSalesUser : System.Web.UI.Page
    {
        ...
        {
            #region Added by Sonali Agarwal on 18Apr,2017
            string flag = string.Empty;
            #region There are 2 possible solutions. One is commented as below and the other is active.
            if (ddlstatus.SelectedItem.Text.ToLower().Equals("rejected"))
            {
                if ((txtfirstname.Text.Equals("")) || (txtlastname.Text.Equals("")) || (txtPhone.Text.Equals("")) || (ddldesignation.SelectedValue.Equals("0")) ||
                (ddlSource.SelectedValue.Equals("Select Rejection Reason")) || (ddlEmpType.SelectedValue.Equals("0")))
                {
                    ddlstatus.SelectedValue = Convert.ToInt16(JGConstant.InstallUserStatus.Applicant).ToString();
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Overlay", "ValidateControls();", true); return;
                }
            }
            #endregion 
            ...
            //    {
            //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Overlay", "ValidateFirstName();", true); return;
            //    }
            //    if (txtlastname.Text.Equals(""))
            //    {
            //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Overlay", "ValidateLastName();", true); return;
            //    }
            //    if (txtPhone.Text.Equals(""))
            //    {
            //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Overlay", "ValidatePhone();", true); return;
            //    }
            //    if (ddldesignation.SelectedValue.Equals("0"))
            //    {
            //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Overlay", "ValidateDesignation();", true); return;
            //    }
            //    if (ddlSource.SelectedValue.Equals("Select Rejection Reason"))
            //    {
            //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Overlay", "ValidateRejection();", true); return;
            //    }
            //    if (ddlEmpType.SelectedValue.Equals("0"))
            //    {
            //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Overlay", "ValidateEmployee();", true); return;
            //    }
            //}
            #endregion Added by Sonali Agarwal on 18Apr,2017
