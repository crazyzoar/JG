...
namespace JG_Prospect.DAL
{
    public class InstallUserDAL
    {
        ...
        public DataSet GetSalesUsersStaticticsAndData(string strSearchTerm, string strStatus, Int32 intDesignationId, Int32 intSourceId, DateTime? fromdate, DateTime? todate, string AddedByDesignation, int intPageIndex, int intPageSize, string strSortExpression)
        {
            ...
            try
            {
                SqlDatabase database = MSSQLDataBase.Instance.GetDefaultDatabase();
                {
                    ...
                    database.AddInParameter(command, "@AddedByDesignation", DbType.String, AddedByDesignation);
                    if (fromdate != null)
                    {
        ...
        #region Coded by Sonali Agarwal on 21 Apr, 2017
        public DataSet GetRejectionReason()
        {
            try
            {
                ...
                {
                    returndata = new DataSet();
                    DbCommand command = database.GetStoredProcCommand("UDP_GetRejectionReason");
                    command.CommandType = CommandType.StoredProcedure;
                    returndata = database.ExecuteDataSet(command);
                    return returndata;
                }
        ...
        public DataSet CheckDuplicateRejectionReason(string Reason)
        {
            try
            {
                SqlDatabase database = MSSQLDataBase.Instance.GetDefaultDatabase();
                {
                    returndata = new DataSet();
                    DbCommand command = database.GetStoredProcCommand("UDP_CheckDuplicateRejectionReason");
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet AddRejectionReason(string Reason)
        {
            try
            {
                ...
                {
                    returndata = new DataSet();
                    DbCommand command = database.GetStoredProcCommand("UDP_AddRejectionReason");
                    command.CommandType = CommandType.StoredProcedure;
                    database.AddInParameter(command, "@Reason", DbType.String, Reason);
                    returndata = database.ExecuteDataSet(command);
                    return returndata;
        ...
        public void DeleteRejectionReason(string Reason)
        {
            try
            {
                SqlDatabase database = MSSQLDataBase.Instance.GetDefaultDatabase();
                {
                    DbCommand command = database.GetStoredProcCommand("UDP_DeleteRejectionReason");
                    command.CommandType = CommandType.StoredProcedure;
                    database.AddInParameter(command, "@Reason", DbType.String, Reason);
                    database.ExecuteScalar(command);
                }
        ...
        #endregion Coded by Sonali Agarwal on 21 Apr, 2017
    }
}
