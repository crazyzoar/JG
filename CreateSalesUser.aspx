...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        //Added by Sonali Agarwal on 18Apr,2017
        function ValidateControls() {
            var message = "First Name field cannot be empty.\r\n";
            message += "Last Name field cannot be empty.\r\n";
            message += "Phone Number field cannot be empty.\r\n";
            message += "Designation field cannot be empty.\r\n";
            message += "Choose value in Rejection Reason.\r\n";
        ...
        function ValidateLastName() {
            var message = "Last Name field cannot be empty.\r\n";
            alert(message);
        }
        function ValidatePhone() {
            var message = "Phone Number field cannot be empty.\r\n";
            alert(message);
        }
        function ValidateDesignation() {
            var message = "Designation field cannot be empty.\r\n";
            alert(message);
        }
        function ValidateRejection() {
            var message = "Choose value in Rejection Reason.\r\n";
            alert(message);
        }
        function ValidateEmployee() {
            var message = "Choose value in Employee Type.\r\n";
            alert(message);
        }
        <%--function VerifyData() {
            ...
            var ddl = document.getElementById("<%=S0n2li@gClientID%>");
                            ...
                            <table border="0" class="tblUserData" cellspacing="0" cellpadding="0" style="margin-left: 0;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        ...
                                        &nbsp;<asp:Button runat="server" ID="btnAddSource" Text="Add" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" 
                                            OnClick="btnAddSource_Click" Height="30px" />&nbsp;
                                <asp:Button runat="server" ID="btnDeleteSource" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" Text="Delete" 
                                    OnClick="btnDeleteSource_Click" Height="30px" />
                                        <br />
                                        <label>
                                        </label>
                                            ...
                                            <table width="100%" style="border: Solid 3px #b04547; width: 100%; height: 100%"
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <asp:Button ID="Button1" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" CommandName="Submit" runat="server"
                                                            Text="Submit" OnClientClick="return hidePnl();" />
