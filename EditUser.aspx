                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        <tr style="background-color: #A33E3F; color: white; font-weight: bold; text-align: center; width: 100%;">
                            <td>
                                <asp:Label ID="lblUserStatus" Text="User Status" runat="server" />
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="grdUsers" OnPreRender="grdUsers_PreRender" runat="server" CssClass="scroll" Width="100%" EmptyDataText="No Data"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="23%" ItemStyle-Width="23%" SortExpression="Status">
                                    <ItemTemplate>
                                        ...
                                        <div class="GrdContainer" style="width: 90%">
                                            ...
                                            <div class="GrdContent">
                                                <ul style="padding-left: 0px;">
                                                    <li>
                                                        <asp:CheckBox ID="chkIsPrimaryPhone" Text=" Is Primary contact" runat="server"></asp:CheckBox>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <asp:Button ID="btnAddPhone" CssClass="GrdBtnAdd" runat="server" Text="Add" CommandName="AddNewContact" CommandArgument='<%# Eval("Id") %>'></asp:Button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <tr>
                        <td align="right" style="height: 15px;">
                            <label style="text-align: right;">
                                Rejection Reason<asp:Label ID="lblReject" runat="server" Text="*" ForeColor="Red"></asp:Label></label>
                        </td>
                        <td align="left" style="height: 15px;">
                            <asp:DropDownList ID="ddlReject" runat="server" Width="249px" TabIndex="510">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" style="height: 15px;">
                            <asp:TextBox ID="txtReject" runat="server" TextMode="MultiLine" placeholder="Recruiter Comments" Width="140px"></asp:TextBox>

                            &nbsp;<asp:Button runat="server" ID="btnAddReject" Text="Add" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;"
                                OnClick="btnAddReject_Click" Height="30px" />&nbsp;

                            <asp:Button runat="server" ID="btnDeleteReject" Style="background: url(img/main-header-bg.png) repeat-x; color: #fff;" Text="Delete"
                                OnClick="btnDeleteReject_Click" Height="30px" />
                            <br />
                            <label>
                            </label>
                            <asp:RequiredFieldValidator ID="rqReject" runat="server" ControlToValidate="ddlReject" InitialValue="0"
                                ForeColor="Red" Display="Dynamic" ValidationGroup="submit">Enter Rejection Reason</asp:RequiredFieldValidator><br />
                        </td>
                    </tr>
                    <tr>
                ...
                <ContentTemplate>
                    ...
                    <fieldset>
                        <legend>
                            ...
                            <asp:HiddenField ID="hdnEmailTo" runat="server" />
                        </legend>
                    ...
                    <asp:GridView ID="grdUsers_Popup" runat="server" AutoGenerateColumns="false" DataKeyNames="Id"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Name" ItemStyle-Width="150">
                                <ItemTemplate>
                                    <asp:Literal ID="ltrlFirstName" runat="server" Text='<%#Eval("FirstName") %>' />
                                    &nbsp;
                                    <asp:Literal ID="ltrlLastName" runat="server" Text='<%#Eval("LastName") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
